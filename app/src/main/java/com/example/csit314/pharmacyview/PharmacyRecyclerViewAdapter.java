...
public class PharmacyRecyclerViewAdapter extends RecyclerView.Adapter<PharmacyRecyclerViewAdapter.MyViewHolder> {
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder
    {
        ...
        {
            super(itemView);
            item_prescription = (LinearLayout)itemView.findViewById(R.id.prescription_item_id);
            tv_patient_name = (TextView)itemView.findViewById(R.id.pharmacy_patient_name);
            tv_patient_email = (TextView)itemView.findViewById(R.id.pharmacy_patient_email);
            tv_name = (TextView)itemView.findViewById(R.id.pharmacy_prescription_name);
            tv_date = (TextView)itemView.findViewById(R.id.pharmacy_prescription_date);
            tv_amount = (TextView)itemView.findViewById(R.id.pharmacy_prescription_amount);
            tv_status = (TextView)itemView.findViewById(R.id.pharmacy_prescription_status);
        }
    }
    public PharmacyRecyclerViewAdapter(List<Prescription> prescriptionData,List<Patient> patientData,String email,String password)
    {
    ...
    {
        View v;
        v = LayoutInflater.from(parent.getContext()).inflate(R.layout.pharmacy_view_list,parent,false);
        ...
        vHolder.item_prescription.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                intent = new Intent(parent.getContext(),PharmacyUpdatePrescriptionActivity.class);
    ...
    @Override
    public void onBindViewHolder(@NonNull PharmacyRecyclerViewAdapter.MyViewHolder holder, int position) {
